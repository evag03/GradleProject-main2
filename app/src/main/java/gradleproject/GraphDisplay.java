    ...
    for (Object n : nodes) {
      if (net != null) {
        ...
        if (graph != null) {
          ...
          succ = vgraph.successors(n);     // whoops? vgraph not graph    
        } else {
          return edges;
        }
        for (Object s : succ) {
  ...
  */
  ...
  public class Diset<T> {
    ...
    public boolean equals(Object o) {
      ...
      if (getClass() != o.getClass()) // type check and cast
          return false;
      // beginning of Skye's bodge
      if (o instanceof Diset ){
        Diset p = (Diset) o;
        return (Objects.equals(p1, p.p1) && Objects.equals(p2, p.p2))
            || (Objects.equals(p2, p.p1) && Objects.equals(p1, p.p2)); // field comparison
      }
      // end of Skye's bodge
      Pair p = (Pair) o; //our graph is undirected, so this might be causing some errors... our graph uses diset i think) 
      return (Objects.equals(p1, p.p1) && Objects.equals(p2, p.p2))
        ||(Objects.equals(p2, p.p1) && Objects.equals(p1, p.p2)); // field comparison
    }
